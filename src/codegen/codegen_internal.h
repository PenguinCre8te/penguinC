...
typedef struct {
    ...
    /* Generic class templates: stores AST nodes for @generics classes */
    struct { char *name; AstNode *decl; int dispatch; /* 0=static, 1=dynamic */ } *generic_classes;
    size_t generic_class_count;
    size_t generic_class_cap;
